...
// Tested contracts
const OyaModule = getContract("OyaModuleTest");
...
describe("OyaModule", () => {
  ...
  beforeEach(async function () {
    ...
    optimisticOracleModule = await OyaModule.new(
      finder.options.address,
  ...
  it("Proposals can be executed with minimal proxy Oya Module", async function () {
    ...
    const proxyOptimisticOracleModule = await getContract("OyaModuleTest").at(proxyAddress);
